...
* Replaced `ng-reflect-dialog-result` reference from dialog scss selectors with `cancel` class ([0c2501f](https://github.com/OntimizeWeb/ontimize-web-ngx-theming/commit/0c2501f)) Closes [#118](https://github.com/OntimizeWeb/ontimize-web-ngx-theming/issues/118)
